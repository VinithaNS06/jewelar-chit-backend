...
// const End_date=moment().add(1, 'months').format('YYYY-MM-DD hh:mm:ss');

const TransactionSchema  = new mongoose.Schema({
    userid:{ type:mongoose.Schema.Types.ObjectId,required: true, ref:'m8it_users' },
    ...
    // date_off:{ type: String, required: false ,default:End_date},
