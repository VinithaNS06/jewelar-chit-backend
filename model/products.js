...
const ProductSchema  = new mongoose.Schema({
    category_id:{ type:mongoose.Schema.Types.ObjectId,required: true, ref:'m8it_categories' },
    skuid:{type: String,required: false,trim: true,default:0},
    title:{type: String,required: true,trim: true},
    product:{type: String,required: true,trim: true},
    total_installment:{type: Number,required: true,trim: true},
    ...
    secondaryprice:{type: Number,required: true,trim: true,default:0},
    image:{type: String,required: true,trim: true},
    secondaryimage:{type:String,required: true,trim: true},
